    ...
    <div className="min-h-screen flex flex-col bg-gray-50 font-['Fredoka_One',_sans-serif]">
      ...
      <nav className="sticky top-0 bg-white shadow-sm z-50 transition-all duration-300 ease-in-out hover:shadow-md">
        <div className="container mx-auto px-4 sm:px-6 py-2 flex justify-between items-center">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-lg sm:text-xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-red-500 via-yellow-500 to-blue-500">MINDFUL.NET</span>
          </div>
          <div className="hidden md:flex space-x-6 text-sm font-medium">
            <Link href="#inicio" className="hover:text-blue-500 transition duration-300">Inicio</Link>
            <Link href="#informacion" className="hover:text-green-500 transition duration-300">Información</Link>
            <Link href="#contacto" className="hover:text-purple-500 transition duration-300">Contacto</Link>
          </div>
          <div className="md:hidden">
            <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="text-blue-500 hover:text-purple-500 transition duration-300">
        ...
        <div className={`md:hidden bg-white py-2 px-4 transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-48 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
          <Link href="#inicio" className="block py-2 text-sm font-medium text-blue-500 hover:text-purple-500 transition duration-300" onClick={() => setIsMenuOpen(false)}>Inicio</Link>
          <Link href="#informacion" className="block py-2 text-sm font-medium text-green-500 hover:text-yellow-500 transition duration-300" onClick={() => setIsMenuOpen(false)}>Información</Link>
          <Link href="#contacto" className="block py-2 text-sm font-medium text-purple-500 hover:text-red-500 transition duration-300" onClick={() => setIsMenuOpen(false)}>Contacto</Link>
        </div>
      </nav>

      <header id="inicio" className="bg-gradient-to-b from-gray-100 to-white py-20 sm:py-32 text-center">
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-extrabold mb-6 leading-tight tracking-tighter">MINDFUL.NET</h1>
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-8">Comprometidos con la educación consciente</h2>
      ...
      <main className="flex-grow">
        <section className="container mx-auto px-4 sm:px-6 py-20">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-center mb-16 animate-on-scroll leading-tight">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 sm:gap-16">
            {[
              ...
              <div key={index} className={`text-center p-8 bg-white rounded-xl shadow-sm transition-all duration-300 hover:shadow-md hover:bg-gray-50 animate-on-scroll`} style={{transitionDelay: `${index * 200}ms`}}>
                ...
                <h3 className="text-2xl sm:text-3xl font-bold mb-6">{item.title}</h3>
        ...
        <section id="informacion" className="bg-gradient-to-b from-gray-100 to-white py-20">
          <div className="container mx-auto px-4 sm:px-6">
            <h2 className="text-4xl sm:text-5xl font-bold text-center mb-20 animate-on-scroll leading-tight">
            ...
            {activities.map((activity, index) => (
              <div key={index} className={`flex flex-col md:flex-row items-center mb-24 ${index % 2 === 0 ? 'md:flex-row-reverse' : ''} animate-on-scroll`}>
                ...
                <div className="md:w-1/2 md:px-12">
                  <h3 className="text-3xl sm:text-4xl font-bold mb-8 leading-tight">{activity.title}</h3>
                  <p className="text-lg sm:text-xl mb-8 leading-relaxed">{activity.description}</p>
                  <div className="mb-6">
                    <h4 className="text-xl sm:text-2xl font-semibold mb-3">Objetivo</h4>
                    <p className="text-base sm:text-lg leading-relaxed">{activity.objetivo}</p>
                  </div>
                  <div className="mb-6">
                    <h4 className="text-xl sm:text-2xl font-semibold mb-3">Beneficio</h4>
                    <p className="text-base sm:text-lg leading-relaxed">{activity.beneficio}</p>
                  </div>
                  <div className="mb-6">
                    <h4 className="text-xl sm:text-2xl font-semibold mb-3">Actividad</h4>
                    <p className="text-base sm:text-lg leading-relaxed">{activity.actividad}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <section className="bg-gray-50 py-20 text-center">
          <h2 className="text-4xl sm:text-5xl font-bold mb-10 animate-on-scroll leading-tight">
            ¡Comparte tu Experiencia Online!
          </h2>
          <p className="text-xl sm:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed animate-on-scroll">
          ...
          <a 
            ...
            className="inline-flex items-center px-8 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-red-500 via-yellow-500 to-blue-500 text-white font-bold text-lg sm:text-xl rounded-full hover:opacity-90 transition-all duration-300 hover:shadow-lg hover:scale-105 animate-on-scroll"
          >
        ...
        <div className="container mx-auto px-4 sm:px-6 py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="animate-on-scroll">
              <h3 className="text-2xl sm:text-3xl font-bold mb-6">MINDFUL.NET</h3>
              <p className="text-base sm:text-lg mb-4 leading-relaxed">Transformando vidas a través de la conciencia plena</p>
              <p className="text-base sm:text-lg leading-relaxed">Dirigido por las Licenciadas Sabrina Pedrozo </p>
            </div>
            <div className="animate-on-scroll" style={{transitionDelay: '200ms'}}>
              <h4 className="text-xl sm:text-2xl font-semibold mb-6">Enlaces rápidos</h4>
              <ul className="space-y-3">
                <li><Link href="#inicio" className="text-base sm:text-lg hover:text-blue-500 transition duration-300">Inicio</Link></li>
                <li><Link href="#informacion" className="text-base sm:text-lg hover:text-green-500 transition duration-300">Información</Link></li>
                <li><Link href="#" className="text-base sm:text-lg hover:text-yellow-500 transition duration-300">Sobre nosotros</Link></li>
                <li><Link href="#" className="text-base sm:text-lg hover:text-purple-500 transition duration-300">Servicios</Link></li>
              </ul>
            </div>
            <div className="animate-on-scroll" style={{transitionDelay: '400ms'}}>
              <h4 className="text-xl sm:text-2xl font-semibold mb-6">Contáctanos</h4>
              <p className="text-base sm:text-lg mb-3 leading-relaxed">Email: info@mindful.net</p>
              <p className="text-base sm:text-lg mb-6 leading-relaxed">Teléfono: +1 234 567 890</p>
              <div className="flex space-x-6 mt-4">
                <a href="#" className="text-blue-500 hover:text-purple-500 transition duration-300">
                ...
                <a href="#" className="text-pink-500 hover:text-red-500 transition duration-300">
